...
## Android RTSP server/output

`VLCMediaPlayer` opens and plays RTSP inputs. To publish a file or network media source from an Android device, add the `VLCRtspServer` component. See [RTSP_SERVER_ANDROID.md](RTSP_SERVER_ANDROID.md) for setup, client URLs, transcoding, and Android lifecycle limitations.
